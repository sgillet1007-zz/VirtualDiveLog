$(document).on('ready', function(){
    ...
    function onMapClick(e) {
        ...
        var currentDive = {
            ...
            "properties": {
                "id": diveString,
                "popupContent": diveString+"<br>"+location+"<br>"+date,
        ...
        // add log record entry newest on top
    ...
    // delegated event toggles log-record-details on header click event. when this was inside mapclick and not delegated, a listener got added to each header on each map click
    $(document).on('click','.log-record-header',function(){
            $(this).siblings().toggle(600);
    })

    // Zoom buton click handlers
